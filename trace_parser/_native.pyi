...
class TraceExit:
    ...
    comm: str
    exit_tgid: int
    def __init__(self, thread_name: str, tid: int, tgid: int, cpu: int, flags: str, timestamp: float, pid: int, comm: str, exit_tgid: int) -> None: ...
    @staticmethod
    def can_be_parsed(line: str) -> bool: ...
    @staticmethod
...
class TraceMarkBegin:
    ...
    trace_mark_tgid: int
    message: str
    def __init__(self, thread_name: str, tid: int, tgid: int, cpu: int, flags: str, timestamp: float, event_name: str, payload_raw: str, trace_mark_tgid: int, message: str) -> None: ...
    @staticmethod
    def can_be_parsed(line: str) -> bool: ...
    @staticmethod
...
class TraceReceiveVsync:
    ...
    message: str
    frame_number: int
    def __init__(self, thread_name: str, tid: int, tgid: int, cpu: int, flags: str, timestamp: float, trace_mark_tgid: int, message: str, frame_number: int) -> None: ...
    @staticmethod
    def can_be_parsed(line: str) -> bool: ...
    @staticmethod
