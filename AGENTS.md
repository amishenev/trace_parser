...
- `#[derive(TraceEvent)]` for normal events
- `#[derive(TracingMarkEvent)]` for `tracing_mark_write` subtypes described by payload templates
- Attributes: `#[trace_event(...)]`, `#[define_template(...)]`, `#[trace_markers(...)]`, `#[field(...)]`
