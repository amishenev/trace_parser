...
**Все основные проблемы исправлены. Миграция всех типовых событий завершена.**

### Отложено

- **E2E тесты с реальными trace файлами** — требуют дополнительной проработки
...
- [ ] Наследование через PyO3 `extends` — см. INHERITANCE_PLAN.md
- [x] Миграция всех оставшихся событий на макрос ✅
